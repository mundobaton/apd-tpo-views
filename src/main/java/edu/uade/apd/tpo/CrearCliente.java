...
public class CrearCliente {
	...
	private void initialize() {
		...
		JComboBox comboCondIVA = new JComboBox(condIvaString);
		...
		String[] comboProvString = {"CABA", "Buenos Aires", "Catamarca", "Chaco", "Chubut", "Córdoba", "Corrientes", "Entre Ríos", "Formosa", "Jujuy", "La Pampa", "La Rioja", "Mendoza", "Misiones", "Neuquén", "Río Negro", "Salta", "San Juan", "San Luis", "Santa Cruz", "Santa Fe", "Santiago del Estero", "Tierra del Fuego","Tucumán"};
